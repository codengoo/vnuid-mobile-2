...
class FaceSpoofDetector(context: Context, useGpu: Boolean = false) {
    ...
    init {
        ...
        firstModelInterpreter =
            Interpreter(
                FileUtil.loadMappedFile(context, "models/spoof_model_scale_2_7.tflite"),
                interpreterOptions
            )
        secondModelInterpreter =
            Interpreter(
                FileUtil.loadMappedFile(context, "models/spoof_model_scale_4_0.tflite"),
                interpreterOptions
            )
    }
